                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropDown">
                                <a class="dropdown-item" id="pvote" href="{{ route('federalElectionPage') }}">Federal Election</a>
                                <a class="dropdown-item" id="svote" href="{{ route('stateElectionPage') }}">State Election</a>
                            </div>
                        </li>
                        <li class="nav-item">
